...
namespace FoodDiary.Import.UnitTests.Core
{
    public class JsonParserTests
    {
        ...
        public void ParsePages_ReturnsJsonPages_WhenJsonContainsUniquePageDates(JsonExportFileDto jsonObj)
        {
        ...
        public void ParsePages_ThrowsImportException_WhenJsonDoesNotContainUniquePageDates(JsonExportFileDto jsonObj)
        {
        ...
        public void ParseNotes_ReturnsNotesFromJson_WhenPagesContainValidNotes(IEnumerable<JsonExportPageDto> pagesFromJson)
        {
        ...
        public void ParseNotes_ThrowsImportException_WhenPagesContainAtLeastOneInvalidNote(IEnumerable<JsonExportPageDto> pagesFromJson)
        {
        ...
        public void ParseProducts_ReturnsUniqueProductNames_WhenNotesInfoIsValid(IEnumerable<JsonExportNoteDto> notesFromJson)
        {
        ...
        public void ParseProducts_ThrowsImportException_WhenNotesInfoIsInvalid(IEnumerable<JsonExportNoteDto> notesFromJson)
        {
        ...
        [Theory]
        [JsonNotesWithValidInfoAutoData]
        public void ParseCategories_ReturnsUniqueCategoryNames_WhenNotesInfoIsValid(IEnumerable<JsonExportNoteDto> notesFromJson)
        {
        ...
        public void ParseCategories_ThrowsImportException_WhenNotesInfoIsInvalid(IEnumerable<JsonExportNoteDto> notesFromJson)
        {
